...
from layers_smamba.Mamba_EncDec3 import Encoder, EncoderLayer
from layers_smamba.Embed import DataEmbedding_inverted
...
class SMamba(nn.Module):
    def __init__(self, 
        ...
        self.projector_features = nn.Linear(self.num_features, output_dim, bias=True)
